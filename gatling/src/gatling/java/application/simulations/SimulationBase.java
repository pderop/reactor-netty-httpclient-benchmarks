...
public abstract class SimulationBase extends Simulation {
    ...
    public static final Duration DURATION = parseDuration(System.getProperty("duration", "1m"));
    ...
    public static final Duration LEVEL_LASTING = parseDuration(System.getProperty("level.lasting", "1"));
